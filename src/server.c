...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/10 12:25:20 by kchikwam          #+#    #+#             */
/*   Updated: 2025/01/10 12:25:25 by kchikwam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_server(int pid)
{
	...
	ft_printf("▊▊  ▊▊╗%s\n", END);
	ft_printf("\t ╚══════╝   ╚═════╝╚═════╝       ╚══╝     ╚═════╝╚═════╝\n");
	ft_printf("%s\n\t\tPID: %d%s\t\t", YELLOW, pid, END);
	ft_printf("%sServer Banner%s\n", DARK_BLUE, END);
	ft_printf("\t────────────────────────────────────────────\n\n");
}
